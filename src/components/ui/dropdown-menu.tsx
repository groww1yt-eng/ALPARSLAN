...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      // selected (STRONG)
      "aria-selected:bg-primary/30 aria-selected:text-primary aria-selected:font-semibold",

      // selected + hover → selected wins
      "aria-selected:data-[highlighted]:bg-primary/30",
